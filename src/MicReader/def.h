...
#define DET_VOICED_FRAMES_WINDOW 40
#define DET_VOICED_FRAMES_THRESHOLD                                            \
  size_t((float)DET_VOICED_FRAMES_WINDOW * 0.7)
#define DET_UNVOICED_FRAMES_THRESHOLD                                          \
  size_t((float)DET_VOICED_FRAMES_WINDOW * 0.3)
