...
#define STATUS_MIC_INIT_MSK         BIT_POS(0)
#define STATUS_MIC_ON_MSK           BIT_POS(1)
#define STATUS_UNLOCKED_MSK         BIT_POS(2)
#define STATUS_EVENT_KWS_STOP_MSK   BIT_POS(3)
#define STATUS_EVENT_GOOD_MSK       BIT_POS(4)
#define STATUS_EVENT_BAD_MSK        BIT_POS(5)
#define STATUS_STATE_BAD_MSK        BIT_POS(6)
#define STATUS_SYSTEM_SUSPENDED_MSK BIT_POS(7)
#define STATUS_ALL_BITS_MSK         ALL_BITS(8)
#define STATUS_INIT_BITS_MSK        (STATUS_MIC_INIT_MSK)
